...
//单例对象保存
function SplashScreenDataRepository() {//Singleton pattern
	if (typeof SplashScreenDataRepository.instance === 'object'){
		return SplashScreenDataRepository.instance;
	}
	SplashScreenDataRepository.instance = this;
}
...
*/
SplashScreenDataRepository.prototype._safeStorage = function(key: string){
	/*
...
使用 prototype 属性来向对象添加方法
*/
SplashScreenDataRepository.prototype.getCover = function() {
...
使用 prototype 属性来向对象添加方法
*/
SplashScreenDataRepository.prototype.updateCover = function(){
	/*
...
module.exports = SplashScreenDataRepository;
